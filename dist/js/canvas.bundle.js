...
function init() {
  ballArray = [];
  ball = new Ball(canvas.width / 2, canvas.height / 2, speedY, 30, 'red');
  ...
  for (var i = 0; i < ballsAmount; i++) {
    ...
    var x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius + dx, canvas.width - radius);
    var y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius + dy, canvas.height - radius);
